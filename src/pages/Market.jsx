...
/* ---------------------------------------------------------------- products */
const products = [
  { id: 1,  name: 'Black Hoodie',        category: 'hoodie',   image: t_shirt2, price: 49.99 },
  { id: 2,  name: 'Red T‑Shirt',         category: 'tshirt',   image: t_shirt1, price: 19.99 },
  { id: 3,  name: 'Backpack X',          category: 'backpack', image: t_shirt2, price: 59.99 },
  { id: 4,  name: 'Running Shoes',       category: 'shoes',    image: t_shirt1, price: 89.99 },
  { id: 5,  name: 'White Hoodie',        category: 'hoodie',   image: t_shirt2, price: 49.99 },
  { id: 6,  name: 'Blue T‑Shirt',        category: 'tshirt',   image: t_shirt1, price: 19.99 },
  { id: 7,  name: 'Urban Sneakers',      category: 'shoes',    image: t_shirt1, price: 69.99 },
  { id: 8,  name: 'Travel Backpack',     category: 'backpack', image: t_shirt2, price: 64.99 },
  { id: 9,  name: 'Oversized Hoodie',    category: 'hoodie',   image: t_shirt2, price: 54.99 },
  { id: 10, name: 'Minimalist T‑Shirt',  category: 'tshirt',   image: t_shirt1, price: 17.99 },
  { id: 11, name: 'Performance Sneakers',category: 'shoes',    image: t_shirt2, price: 94.99 },
  { id: 12, name: 'Canvas Backpack',     category: 'backpack', image: t_shirt1, price: 57.50 },
  { id: 13, name: 'Cropped Hoodie',      category: 'hoodie',   image: t_shirt1, price: 42.99 },
  { id: 14, name: 'Graphic Tee',         category: 'tshirt',   image: t_shirt2, price: 22.00 },
  { id: 15, name: 'Street Sneakers',     category: 'shoes',    image: t_shirt1, price: 79.99 },
  { id: 16, name: 'Laptop Backpack',     category: 'backpack', image: t_shirt2, price: 61.99 },
  { id: 17, name: 'Classic Hoodie',      category: 'hoodie',   image: t_shirt2, price: 47.99 },
  { id: 18, name: 'V‑Neck T‑Shirt',      category: 'tshirt',   image: t_shirt1, price: 18.99 },
];
...
export default function Market() {
  ...
  return (
    <section className="relative py-10 px-6 max-w-7xl mx-auto">
      ...
      {/* ------------------------------ cart badge */}
      <button
        onClick={() => { setModalOpen(true); setCheckout(false); }}
        className="fixed z-20 top-5 right-5 bg-black text-white px-4 py-2 rounded-full shadow-lg"
      >
        Cart ({totalItems})
      </button>
